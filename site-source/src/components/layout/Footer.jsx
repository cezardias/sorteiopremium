      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-center md:text-left">
            <h3 className="text-xl font-black italic tracking-widest text-white mb-2 uppercase">
              {settings?.footer_company || settings?.site_name || "PREMIUM MULTIMARCAS"}
            </h3>
          ...
          <div className="flex items-center gap-6">
            ...
            <a 
              href={settings?.whatsapp_number || "https://wa.me"} 
              target="_blank" 
              rel="noopener noreferrer"
        ...
        <div className="mt-12 pt-8 border-t border-white/5 text-center">
          <p className="text-gray-500 text-xs font-medium uppercase tracking-widest">
            © {currentYear} {settings?.site_name || "Premium Multimarcas"}. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
